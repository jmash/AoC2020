...
int countLeftBrackets(FILE * input)
{
    char currCh;
...
# 84 "main.c"
    ...
    address_t addresses[] = {1, 2, 4, 4, 5, 5, 2, 3, 3, 4};



    size_t newSize = removeDupes(addresses, 10, sizeof(address_t), cmpAddress_t);

    printAddressArray(addresses, newSize);
    printf("newSize: %ld\n", newSize);
